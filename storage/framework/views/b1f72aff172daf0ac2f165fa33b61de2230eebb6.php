                ...
                <div class="detail_R">
                    <div class="row_ad">
                        ...
                        <div class="row50 success">
                            <input class="ipt1" size="40" name="email" value="<?php echo e(old('email')); ?>" id="LoginForm_email" type="text">

                        </div>
                        <?php if($errors->has('email')): ?>
                            <div style="padding-left: 135px;" class="errorMessage" id="LoginForm_email_em_"><?php echo e($errors->first('email')); ?></div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="row_ad">
                        ...
                        <div class="row50 success">
                            <input class="ipt1" size="40" name="password" value="<?php echo e(old('password')); ?>" id="LoginForm_password" type="password">
                        </div>
                        <?php if($errors->has('password')): ?>
                            <div style="padding-left: 135px;" class="errorMessage" id="LoginForm_password_em_"><?php echo e($errors->first('password')); ?></div>
                        <?php endif; ?>
                    </div>
                    <div class="row_ad">
                        <div class="row_ad">
                            <label>&nbsp;</label>
                            <div class="row50">
                                <p><input id="chkSavePass" name="remember" type="checkbox" <?php echo e(old('remember') ? 'checked' : ''); ?>><span>Lưu tài khoản đăng nhập</span></p>
                        ...
                        <label>&nbsp;</label>
                        <div class="row50">
                            <p><a href="<?php echo e(route('password.request')); ?>">Bạn quên mật khẩu?</a></p>
