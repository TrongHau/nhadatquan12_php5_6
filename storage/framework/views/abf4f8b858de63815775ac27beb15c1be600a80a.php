    ...
    <div class="main-l">
        <div class="box1-left">
            <div class="tit_C cachtren2">
                <span class="icon_star_xanh"></span> <?php echo e($titleArticle->name); ?> tại <?php echo e(isset($local) ? $local : 'Việt Nam'); ?></div>
                                    ...
                                    <div class="detail_nhadatban">
                                        <div class="img_nhadatban">
                                            <a href="/<?php echo e($item['prefix_url'].'-bds-'.$item['id']); ?>">
                                                <img alt="" src="<?php echo e($item['gallery_image'] ? Helpers::file_path($item['id'], PUBLIC_ARTICLE_LEASE, true).THUMBNAIL_PATH.json_decode($item['gallery_image'])[0] : THUMBNAIL_DEFAULT); ?>">
                                            </a>
                                        ...
                                        <div class="text_nhadatban">
                                            <div class="info_nhadatban">
                                                <ul>
                                                    ...
                                                    <li>Diện tích: <span class="saleboldtext"><?php echo e($item['area'] ? number_format($item['area']).' m²' : 'Chưa xác định'); ?></span></li>
                                                    <li>Khu vực: <span class="saleboldtext"><a href="/tim-kiem-nang-cao/nha-dat-ban/-1/-1/<?php echo e($item['district_id']); ?>/-1/-1/-1/-1/-1/-1/-1"><?php echo e($item['district']); ?></a>,
                                                                <a href="/tim-kiem-nang-cao/nha-dat-ban/-1/<?php echo e($item['province_id']); ?>/-1/-1/-1/-1/-1/-1/-1/-1"><?php echo e($item['province']); ?></a></span></li>
                                                </ul>
                                            </div>
                                            <div class="contact_nhadatban">
                                                <ul>
                                                    ...
                                                    <li class="gia"><strong class="camcam"><?php echo e($item['price_real'] == 0 ? 'Thỏa thuận' : number_format($item['price']).' '.$item['ddlPriceType']); ?></strong></li>
                                                </ul>
                                            </div>
                                        </div>
