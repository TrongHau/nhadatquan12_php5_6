                    ...
                    <div class="row_ad">
                        ...
                        <div class="row50">
                            ...
                            <div class="login-social">
                                <div class="login-facebook" ><div class="fa fa-facebook-square"></div><a href="/auth/facebook"> Đăng ký qua Facebook</a><input type="hidden" id="hddFacebookToken" value=""></div><div class="login-google"><div class="fa fa-google-plus-square"></div><a href="/auth/google"> Đăng ký qua Google</a></div>
                            </div>
                        </div>
                    </div>
                </div>
