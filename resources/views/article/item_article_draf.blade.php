                ...
                <div class="box_nhadatban  clearfix">
                    ...
                    <div class="detail_nhadatban">
                        <div class="img_nhadatban">
                            <a target="_blank" href="/{{$item['prefix_url'].'-bds-'.$item['id']}}"><img src="{{$item['gallery_image'] ? Helpers::file_path($item['id'], ($item['typeOf'] == 'lease' ? PUBLIC_ARTICLE_LEASE :PUBLIC_ARTICLE_BUY), true).THUMBNAIL_PATH.json_decode($item['gallery_image'])[0] : THUMBNAIL_DEFAULT }}" alt=""></a>
                         ...
                         <span class="camcam">{{date_format(date_create($item['updated_at']), "d-m-Y")}}</span>
                                    ...
                                    <li>
                                        <ul class="chucnang_tindang">
                                            <li class="suatin_icon"><a href="{{$item['typeOf'] == 'lease' ? '/quan-ly-tin/dang-tin-ban-cho-thue/' : '/quan-ly-tin/dang-tin-can-mua-can-thue/'}}{{$item['id']}}">Sửa tin</a></li>
                                            <li class="xoatin_icon"><a class="delete-property" onclick="deleteArticle('{{$item['id']}}', {{$item['typeOf'] == 'lease' ? 1 : 2}})" data-property-id="994" href="javascript:void(0)">Xóa tin</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
